...
if __name__ == '__main__':
    ...
    parser.add_argument("-b", "--batch_size", help="batch_size", default=95, type=int)
    parser.add_argument("-w", "--num_workers", help="workers number", default=8, type=int)
    parser.add_argument("-d", "--data_mode", help="use which database, [vgg, ms1m, emore, concat]", default='celeba', type=str)
